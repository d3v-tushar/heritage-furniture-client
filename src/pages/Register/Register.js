...
const Register = () => {
  ...
  return (
    <section className="bg-white w-full lg:w-11/12 mx-auto dark:bg-gray-900">
      <div className="flex justify-center min-h-screen">
        <div
          className="hidden bg-cover lg:block lg:w-2/5"
          style={{backgroundImage: 'url(https://eskil.qodeinteractive.com/wp-content/uploads/2022/03/main-img-1.jpg)'}}
        ></div>
