...
//   const [error, setError] = useState(false);
  ...
  return (
    <section class="bg-white w-full lg:w-11/12 mx-auto dark:bg-gray-900">
      <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleSubmit} class="w-full max-w-md">
          ...
          <h1 class="mt-3 text-center text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">
            Please Login!
          </h1>
